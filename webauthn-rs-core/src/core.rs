...
mod tests {
    ...
    fn test_registration_duo_go() {
        ...
        let chal =
            Challenge::new(URL_SAFE_NO_PAD_ENGINE.decode("+Ri5NZTzJ8b6mvW3TVScLotEoALfgBa2Bn4YSaIObHc").unwrap());
    ...
    fn test_registration_packed_attestation() {
        ...
        let chal =
            Challenge::new(URL_SAFE_NO_PAD_ENGINE.decode("lP6mWNAtG+/Vv15iM7lb/XRkdWMvVQ+lTyKwZuOg1Vo=").unwrap());
    ...
    fn test_registration_ipados_5ci() {
        ...
        let chal =
            Challenge::new(URL_SAFE_NO_PAD_ENGINE.decode("tvR1m+d/ohXrwVxQjMgH8KnovHZ7BRWhZmDN4TVMpNU=").unwrap());
