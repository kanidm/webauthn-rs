...
mod test {
    ...
    fn encrypt_decrypt_expected() {
        ...
        // Encrypting the same value again should use a different nonce, and thus different
        // ciphertext.
        let expected_crypted2 = [
            0x15, 0xad, 0x06, 0x40, 0x3f, 0x68, 0xfc, 0xed, 0x80, 0x2b, 0x37, 0x09, 0xac, 0x2e,
            0x9a, 0xb5, 0xed, 0x40, 0x91, 0x71, 0xc7, 0xfc, 0x23, 0xc0, 0xc0, 0xad, 0x53, 0x72,
            0x97, 0xb7, 0x00, 0x19, 0x04, 0x2e, 0x73, 0x32, 0x1b, 0xdd, 0x4d, 0x03, 0x8f, 0xe0,
            0x23, 0x74, 0x19, 0x60, 0xfc, 0x82, 0x43, 0x82, 0xda, 0x53, 0x87, 0xd9, 0x3b, 0x42,
            0x32, 0x72, 0x7b, 0x89, 0xfc, 0x86, 0xac, 0x08, 0x9b, 0xc2, 0x95, 0xba, 0x14, 0x3a,
            0x86, 0x79, 0x68, 0x44, 0x3b, 0xe8, 0x54, 0x06, 0x73, 0xda,
        ];
        let mut crypted = alice.encrypt(msg).unwrap();
